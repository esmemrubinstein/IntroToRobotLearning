...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        n_samples = self.obs.shape[0]
        ixs = np.random.permutation(n_samples)[:batch_size]

        return self.obs[ixs],self.acs[ixs], self.rews[ixs], self.next_obs[ixs], self.terminals[ixs]
